# Compare the 2 deconvolve objects with cttest
...
### compare between 2 groups using cttest ###
unique(annotation_table$group) # to see the options to compare between
group_a_name <- "bladder cancer_epithelial"
group_b_name <- "bladder cancer_inflamed"

# run CT test for manipulated data
